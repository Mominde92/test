...
export function Footer() {
  return (
    <footer className="bg-[#fff1e4] font-footer">
      <div className="mx-auto grid max-w-[1450px] gap-7 px-5 py-8 md:grid-cols-2 md:px-8 lg:grid-cols-[1.35fr_1fr_1fr_1.35fr_1fr] lg:py-10">
        <div>
        ...
        <div>
          ...
          <p className="mt-3 max-w-[300px] text-[13px] font-normal leading-none text-ink">
      ...
      <div className="bg-magenta px-5 py-3 text-center font-footer text-[13px] font-semibold leading-none text-white">
